...
template<>
bool ExperimentalPlanner::Enqueue(const LinePathPrimitive &path,
                                  const double requested_feedrate) {
  return true;
}

template<>
bool ExperimentalPlanner::Enqueue(const CircularArcPathPrimitive &path,
                                  const double requested_feedrate) {
  return true;
}

template<>
bool ExperimentalPlanner::Enqueue(const CubicBezierPathPrimitive &path,
                                  const double requested_feedrate) {
  return true;
}
